...
//        var sessid: String!
//        let tmdbSession = AuthManager(apiKey: "41f36ebf35f37b9fa80bd760c722709f")
//        tmdbSession.authenticate { error in
//            if let error = error {
//                print("Authentication failed with error: \(error)")
//            } else {
//                //print("Authentication successful!")
//                sessid = tmdbSession.sessionId ?? "N/A"
//            }
//        }
//
//        var accountid: Int!
//        let session = AccountManager(apiKey: "41f36ebf35f37b9fa80bd760c722709f" , sessionId: sessid)
//        session.fetchAccountId { error in
//            if let error = error {
...
//        API_Request.shared.getRequestToken(apiKey: "41f36ebf35f37b9fa80bd760c722709f") { (requestToken) in
...
//        }
            // Use the request token to create a session
        
//
//        let username = "vdesiraju"
//        let password = "Archu.1318"
//
//        var sessionid: String?
//        API_Request.shared.createSession(with: requesttoken!, username: username, password: password) { sessionId in
...
//
//            sessionid = sessionId
//            // Use the session ID to make authenticated API requests
//        }
        
//        let movieId = 594767
//
//
//        API_Request.shared.getAccountId(apiKey: "41f36ebf35f37b9fa80bd760c722709f", sessionID: "9f3d1d2bbc80d51c5e319e3859324b746753444a") { error in
//
...
//        API_Request.shared.fetchFavoriteMovies(sessionId: sessionid ?? "nil", apiKey: apiKey) { favmovies, error in
//            DispatchQueue.main.async {
//                if let favoriteMovies = favmovies {
//                    self.favmovies = favoriteMovies
...
//                    } else {
//                        print("Unknown error fetching favorite movies")
//                    }
//                }
//            }
//        }
...
//        }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // Set the switch action closure
        cell.switchValueChanged = { isOn in
            if isOn {
                print("Switch for cell \(indexPath.row) turned on")
                MovieController.sharedMovie.fetchNowPlayingMovies() {success in}
            } else {
        ...
        case 0:
            ...
            let vote = popularMovies?.results[indexPath.row].voteCount ?? 0
            cell.votecount.text = String(vote)
        ...
        case 1:
            ...
            cell.switchValueChanged = { isOn in
                    if isOn {
                        ...
                        API_Request.shared.addToFavorites(movieId: movieid, sessionId: "9f3d1d2bbc80d51c5e319e3859324b746753444a", apiKey: "41f36ebf35f37b9fa80bd760c722709f"){ error in
                            if let error = error {
